...
In this guide we will show you how to create a Maven `pom.xml` file and how to configure it to support Ktor.
...
Now you have to add the `ktor-server-core` artifact using the `ktor.version` you specified:
