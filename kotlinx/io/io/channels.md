...
They are useful for reading and writing to sockets or files from start to end.
Usually you read and create chunks of synchronous data called [Packets](/kotlinx/io/io/packets.html) from them, reducing the amount of suspensions to packets.
